...
mv  -Path 'C:\Security Baseline\Windows Server-2022-Security-Baseline-Final\' -Destination 'C:\Security Baseline\' -Force
...
mv -Path 'C:\Security Baseline\Windows 11 v25H2 Security Baseline' -Destination 'C:\Security Baseline\' -Force
