...
mv 'C:\Security Baseline\Windows Server 2022 Security Baseline' 'C:\Security Baseline\' -Force
mv 'C:\Security Baseline\Windows Server-2022-Security-Baseline-Final\' 'C:\Security Baseline\' -Force
...
Expand-Archive -Path 'Windows 10 Version 1809 and Windows Server 2019 Security Baseline.zip' -DestinationPath 'C:\Security Baseline' -force
mv 'C:\Security Baseline\Windows 10 Version 1809 and Windows Server 2019 Security Baseline' 'C:\Security Baseline\' -Force
...
mv 'C:\Security Baseline\Windows 11 v25H2 Security Baseline' 'C:\Security Baseline\' -Force
mv 'C:\Security Baseline\Windows 11 v25H2 Security Baseline' 'C:\Security Baseline\' -Force
